class ValidInput(object):
    ...
    def test_correctness_valueForSmallIndices(self):
        self.assertEqual(0, self.base_function(0))
        self.assertEqual(1, self.base_function(1))
        self.assertEqual(1, self.base_function(2))
        self.assertEqual(2, self.base_function(3))
        self.assertEqual(28657, self.base_function(23))

    def test_correctness_differentIntegerRepresentation_forInt18(self):
        self.assertEqual(2584, self.base_function(0x12))
        self.assertEqual(2584, self.base_function(0o22))
        self.assertEqual(2584, self.base_function(0b10010))

    def test_correctness_fakeTupleOfOne(self):
        # this is not a tuple, but int; tuple is defined by comma
        self.assertEqual(3, self.base_function((4)))
